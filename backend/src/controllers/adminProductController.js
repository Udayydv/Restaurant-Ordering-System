...
export const createProduct = async (req, res) => {
  try {
    ...
    const product = await Product.create({
      ...
      isBestseller,
      sortOrder,
      section: section === "sip-n-scoop" ? "sip-n-scoop" : "restaurant",
    });
...
export const deleteProduct = async (req, res) => {
  try {
    ...
    // Soft-delete every product. This is intentional: curated products are
    // synchronized from seed data when the backend starts, so a hard delete
    // would cause them to be recreated on the next Render restart.
