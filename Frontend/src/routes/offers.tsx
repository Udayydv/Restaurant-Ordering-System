  ...
  head: () => ({
    meta: [
      { title: "Offers & Deals — Tripathi Veg Restaurant" },
      {
        name: "description",
        content:
          "Live offers at Tripathi Veg Restaurant: ₹50 off a ₹399+ order with one-time WELCOME50, catering deals and nearby delivery.",
      },
      { property: "og:title", content: "Offers & Deals — Tripathi Veg Restaurant" },
      {
        property: "og:description",
        content: "New customers can use WELCOME50 once for ₹50 off a ₹399+ order, plus catering and delivery deals.",
      },
    ],
  }),
