...
export const restaurant = {
  ...
  promo: "₹50 OFF on ₹399+ • WELCOME50 one-time per new account • Sip n Scoop ₹10 within 3 km",
  deliveryFee: 5,
...
export const whyDirect = [
  {
    icon: "🚴",
    title: "Delivery from ₹5",
    text: "Nearby delivery starts at ₹5, with fees calculated by distance.",
  },
  {
    icon: "💰",
...
export const offers = [
  ...
  },
  {
    ...
    text: "New customers can use WELCOME50 once on an online order with an item total of ₹399 or more.",
  ...
  },
  {
    icon: "🚴",
    title: "Delivery from ₹5",
    text: "Restaurant delivery is distance-based. Sip n Scoop is exactly ₹10 within its 3 km quick-delivery zone.",
